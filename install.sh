...
files="bashrc bash_aliases bash_functions vimrc vim tmux.conf irssi gitignore_global desk agignore ctags inputrc bash_profile"    # list of files/folders to symlink in homedir
